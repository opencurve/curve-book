...
![chunkserver arch](../../images/chunkserverstructure.png)
...
+ Internal Service Layer
    ...
    - CloneManager
      ...
      CloneManager主要负责克隆相关的功能，内部是一个线程池，主要负责异步完成克隆chunk的数据补全。关于克隆相关的内容请参考[克隆快照文档](https://docs.opencurve.io/CurveBS/architecture/snapshot)。
...
![heartbeat](../../images/chunkserver_heartbeat.png)
